...
WVU:RFSoC:transmitter_lfsr256_v10:23.0\
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set PPS [ create_bd_port -dir I -from 0 -to 0 -type data PPS ]
  set_property -dict [ list \
   CONFIG.LAYERED_METADATA {xilinx.com:interface:datatypes:1.0 {DATA {datatype {name {attribs {resolve_type immediate dependency {} format string minimum {} maximum {}} value {}} bitwidth {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 1} bitoffset {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 0} real {fixed {fractwidth {attribs {resolve_type immediate dependency {} format long minimum {} maximum {}} value 0} signed {attribs {resolve_type immediate dependency {} format bool minimum {} maximum {}} value false}}}}}}} \
 ] $PPS
  set led_tx_active [ create_bd_port -dir O -from 0 -to 0 led_tx_active ]
  ...
  set_property -dict [ list \
   CONFIG.CLKIN1_JITTER_PS {43.4} \
   CONFIG.CLKOUT1_DRIVES {BUFGCE} \
   CONFIG.CLKOUT1_JITTER {82.991} \
   CONFIG.CLKOUT1_PHASE_ERROR {89.384} \
   ...
   CONFIG.MMCM_CLKFBOUT_MULT_F {3.500} \
   CONFIG.MMCM_CLKIN1_PERIOD {4.340} \
   CONFIG.MMCM_CLKIN2_PERIOD {10.0} \
   CONFIG.MMCM_CLKOUT0_DIVIDE_F {2.625} \
   CONFIG.MMCM_CLKOUT0_DUTY_CYCLE {0.5} \
   CONFIG.MMCM_DIVCLK_DIVIDE {1} \
   CONFIG.PRIM_IN_FREQ {230.4} \
  ...
  set transmitter [ create_bd_cell -type ip -vlnv WVU:RFSoC:transmitter_lfsr256_v10:23.0 transmitter ]
  ...
  set_property -dict [ list \
   ...
   CONFIG.ADC2_Refclk_Freq {1228.800} \
   CONFIG.ADC2_Sampling_Rate {1.2288} \
   CONFIG.ADC_Data_Type22 {0} \
   CONFIG.ADC_Data_Type23 {0} \
   CONFIG.ADC_Data_Width22 {3} \
   CONFIG.ADC_Data_Width23 {3} \
   ...
   CONFIG.DAC2_Outclk_Freq {230.400} \
   CONFIG.DAC2_PLL_Enable {true} \
   CONFIG.DAC2_Refclk_Freq {409.600} \
   CONFIG.DAC2_Sampling_Rate {3.6864} \
  ...
  connect_bd_intf_net -intf_net ps8_axi_periph_M01_AXI [get_bd_intf_pins ps8_axi_periph/M01_AXI] [get_bd_intf_pins transmitter/transmitter_lfsr256_v10_s_axi]
  ...
  connect_bd_intf_net -intf_net transmitter_lfsr256_0_m_axis [get_bd_intf_pins transmitter/m_axis] [get_bd_intf_pins usp_rf_data_converter/s20_axis]
  ...
  connect_bd_net -net PPS_1 [get_bd_ports PPS] [get_bd_pins transmitter/pps_in]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_mem_intercon_hp0/ACLK] [get_bd_pins axi_mem_intercon_hp0/M00_ACLK] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins proc_sys_reset_dac1/slowest_sync_clk] [get_bd_pins usp_rf_data_converter/clk_dac2] [get_bd_pins zynq_ultra_ps_e/saxihp0_fpd_aclk]
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins axi_dma_tx/m_axi_mm2s_aclk] [get_bd_pins axi_dma_tx/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon_hp0/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins ps8_axi_periph/M01_ACLK] [get_bd_pins ps8_axi_periph/M02_ACLK] [get_bd_pins transmitter/clk] [get_bd_pins usp_rf_data_converter/s2_axis_aclk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins axi_dma_tx/axi_resetn] [get_bd_pins axi_mem_intercon_hp0/S00_ARESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins ps8_axi_periph/M01_ARESETN] [get_bd_pins ps8_axi_periph/M02_ARESETN] [get_bd_pins transmitter/transmitter_lfsr256_v10_aresetn] [get_bd_pins usp_rf_data_converter/s2_axis_aresetn]
  connect_bd_net -net proc_sys_reset_dac1_peripheral_aresetn [get_bd_pins axi_mem_intercon_hp0/ARESETN] [get_bd_pins axi_mem_intercon_hp0/M00_ARESETN] [get_bd_pins proc_sys_reset_dac1/peripheral_aresetn]
  ...
  connect_bd_net -net transmitter_m_axis_tvalid [get_bd_ports led_tx_active] [get_bd_pins transmitter/m_axis_tvalid]
  connect_bd_net -net usp_rf_data_converter_irq [get_bd_pins usp_rf_data_converter/irq] [get_bd_pins xlconcat/In1]
  ...
  connect_bd_net -net zynq_ultra_ps_e_pl_resetn0 [get_bd_pins proc_sys_reset_0/ext_reset_in] [get_bd_pins proc_sys_reset_dac1/ext_reset_in] [get_bd_pins rst_ps8_99M/ext_reset_in] [get_bd_pins zynq_ultra_ps_e/pl_resetn0]
  ...
  assign_bd_address -offset 0xA0060000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs transmitter/transmitter_lfsr256_v10_s_axi/reg0] -force
